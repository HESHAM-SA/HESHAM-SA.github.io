...
const translations = {
  en: {
    ...
    description: 'Portfolio of Hesham Alsadan — Computer Science teacher and AI practitioner passionate about EdTech and NLP, with 1,500+ hours of training across KAUST, SDAIA, Tuwaiq, and SDA.',
    langButton: 'العربية',
    ...
    text: {
      ...
      '.hero-text': 'Computer Science teacher and AI practitioner in Riyadh, passionate about EdTech and natural language processing — open to contributing to projects that apply AI to education and language.',
      ...
      '.about-text p:nth-of-type(1)': 'I\'m a Data Scientist, AI engineer, and Computer Science teacher with a strong passion for EdTech and NLP. I\'m especially motivated to work on projects that use AI and language technology to improve teaching, learning, and student outcomes.',
      '.about-text p:nth-of-type(2)': 'Through 6 bootcamps and 5 programs at KAUST, SDAIA, Tuwaiq Academy, and SDA, I\'ve completed 1,500+ hours of training in Python, AI, data science, full-stack development, IoT, cloud, and GPU infrastructure — with 100% attendance. I currently teach 170 students at the Ministry of Education while building practical AI solutions, and I\'m actively looking to contribute to NLP and EdTech projects.',
    ...
    html: {
      ...
      '.hero-subtitle': 'AI Engineer <span class="accent">|</span> EdTech &amp; NLP',
  ...
  ar: {
    ...
    description: 'معرض أعمال هشام السعدان — معلّم حاسب ومهتم بالذكاء الاصطناعي، شغوف بـ EdTech وNLP. أكثر من 1,500 ساعة تدريب مع كاوست وسدايا وطويق وSDA.',
    langButton: 'English',
    ...
    text: {
      ...
      '.hero-text': 'معلّم حاسب ومهتم بالذكاء الاصطناعي في الرياض، شغوف بتقنيات التعليم (EdTech) ومعالجة اللغة الطبيعية (NLP) — متحمس للمساهمة في مشاريع تطبّق الذكاء الاصطناعي على التعليم واللغة.',
      ...
      '.about-text p:nth-of-type(1)': 'أنا عالم بيانات ومهندس ذكاء اصطناعي ومعلّم حاسب، واهتمامي الأكبر في EdTech وNLP. أبحث عن فرص للعمل في مشاريع تستخدم الذكاء الاصطناعي وتقنيات اللغة لتحسين التعليم وتجربة الطالب.',
      '.about-text p:nth-of-type(2)': 'شاركت في 6 معسكرات و5 برامج مع كاوست وسدايا وأكاديمية طويق وSDA — أكثر من 1,500 ساعة تدريب في Python والذكاء الاصطناعي وعلوم البيانات وتطوير الويب وإنترنت الأشياء والحوسبة السحابية والبنية التحتية لـ GPU، وحضوري كان 100%. حالياً أدرّس 170 طالباً في وزارة التعليم وأطوّر حلول ذكاء اصطناعي عملية، وأسعى للمساهمة في مشاريع NLP وEdTech.',
    ...
    html: {
      ...
      '.hero-subtitle': 'مهندس ذكاء اصطناعي <span class="accent">|</span> EdTech وNLP',
