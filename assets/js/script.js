...
const translations = {
  en: {
    ...
    text: {
      ...
      '.hero-text': 'AI Engineer and Data Scientist based in Riyadh, building practical AI and data solutions — looking for opportunities in EdTech.',
      ...
      '#about .section-lead': 'Who I am, what I focus on, and the kind of work I\'m looking for.',
      '.about-text p:nth-of-type(1)': 'I\'m an AI Engineer and Data Scientist focused on building intelligent systems and data-driven solutions — and I\'m looking to work in EdTech.',
      '.about-text p:nth-of-type(2)': 'Through 6 bootcamps and 5 programs at KAUST, SDAIA, Tuwaiq Academy, and SDA, I\'ve completed 1,500+ hours of training in Python, AI, data science, full-stack development, IoT, cloud, and GPU infrastructure.',
      ...
      '#experience > .container > .section-lead': 'Training and professional growth.',
      ...
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-date': 'May 10, 2026 - Jun 25, 2026',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-title': 'Software Development using Python Bootcamp Trainee',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-org': 'SDA — Saudi Digital Academy',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-text': 'Completed a 7-week intensive journey in software development using Python, FastAPI, React, and PostgreSQL, building practical programming skills and real-world application experience.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-date': 'Jan - Feb 2026',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-title': 'Advanced Artificial Intelligence',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-org': 'KAUST — King Abdullah University of Science and Technology',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-text': 'Completed 80 hours of advanced training in artificial intelligence, deepening expertise in modern AI techniques, models, and applications.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-date': 'Jun 2025 - Aug 2025',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-title': 'Web Development Bootcamp Trainee',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-org': 'Tuwaiq Academy',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-text': 'Completed 300 hours of intensive training in Python and full-stack web development, with a focus on Django and modern web technologies.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(5) .timeline-date': 'Sep 2024 - Oct 2024',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(5) .timeline-title': 'AI Bootcamp Trainee',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(5) .timeline-org': 'Tuwaiq Academy',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(5) .timeline-text': 'Completed 200 hours of intensive training, gaining hands-on experience in AI, machine learning, and deep learning.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(6) .timeline-date': 'Mar 2024 - Jun 2024',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(6) .timeline-title': 'Data Science and AI T5 Bootcamp Trainee',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(6) .timeline-org': 'SDAIA',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(6) .timeline-text': 'Completed 360 hours of intensive training, covering SQL, Python, data analysis, machine learning, deep learning (CNN, RNN), and MLOps.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(7) .timeline-date': 'Oct 2023 - Dec 2023',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(7) .timeline-title': 'Data Science and Machine Learning Bootcamp Trainee',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(7) .timeline-org': 'Tuwaiq Academy',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(7) .timeline-text': 'Completed 200 hours of intensive training, building 5 projects and 50 labs using Python, SQL, Pandas, Tableau, and TensorFlow. Gained expertise in machine learning (SVM, Decision Tree, Random Forest) and deep learning (CNNs).',
      ...
      '#skills .cert-item:nth-child(1) .cert-name': 'Transformer-Based AI Applications',
    ...
    html: {
      ...
      '.hero-subtitle': 'AI Engineer <span class="accent">|</span> Data Science',
      ...
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(5) .timeline-capstone': '<strong>Capstone — AI Focus Analyzer for E-Learning:</strong> developed an AI platform to analyze student focus during e-learning using facial recognition and quiz performance. <em>Tools: MediaPipe, OpenAI GPT-3.5, Whisper, Streamlit.</em>',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(6) .timeline-capstone': '<strong>Capstone — Hadir, Management Attendance System:</strong> developed an automated student attendance system using facial recognition that classifies student images and records attendance as students enter the classroom. <em>Tools: YOLO, Keras, Roboflow.</em>',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(7) .timeline-capstone': '<strong>Capstone — Haraf, Your Farming Companion:</strong> built from scratch, this CNN-based image classification project identifies date types, maturity, grades, and palm tree diseases. <em>Tools: Python, TensorFlow, Plotly Dash.</em>',
  ...
  ar: {
    ...
    text: {
      ...
      '.hero-text': 'مهندس ذكاء اصطناعي وعالم بيانات في الرياض، أبني حلول ذكاء اصطناعي وتحليل بيانات عملية — أبحث عن فرص في EdTech.',
      ...
      '#about .section-lead': 'نبذة عني، مجالات اهتمامي، ونوع المشاريع اللي أبحث عنها.',
      '.about-text p:nth-of-type(1)': 'أنا مهندس ذكاء اصطناعي وعالم بيانات، أركّز على بناء أنظمة ذكية وحلول مبنية على البيانات — وأبحث عن العمل في EdTech.',
      '.about-text p:nth-of-type(2)': 'شاركت في 6 معسكرات و5 برامج مع كاوست وسدايا وأكاديمية طويق وSDA — أكثر من 1,500 ساعة تدريب في Python والذكاء الاصطناعي وعلوم البيانات وتطوير الويب وإنترنت الأشياء والحوسبة السحابية والبنية التحتية لـ GPU.',
      ...
      '#experience > .container > .section-lead': 'تدريب ونمو مهني.',
      ...
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-date': '10 مايو 2026 - 25 يونيو 2026',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-title': 'معسكر تطوير البرمجيات بـ Python',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-org': 'الأكاديمية السعودية الرقمية — SDA',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-text': '7 أسابيع في تطوير البرمجيات بـ Python وFastAPI وReact وPostgreSQL، مع مشاريع عملية حقيقية.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-date': 'يناير - فبراير 2026',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-title': 'الذكاء الاصطناعي المتقدم',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-org': 'كاوست — جامعة الملك عبدالله للعلوم والتقنية',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-text': '80 ساعة تدريب متقدم في الذكاء الاصطناعي، طوّرت فيها فهمي للتقنيات والنماذج الحديثة.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-date': 'يونيو 2025 - أغسطس 2025',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-title': 'معسكر تطوير الويب',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-org': 'أكاديمية طويق',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-text': '300 ساعة في Python وتطوير الويب الكامل، مع التركيز على Django وتقنيات الويب الحديثة.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(5) .timeline-date': 'سبتمبر 2024 - أكتوبر 2024',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(5) .timeline-title': 'معسكر الذكاء الاصطناعي',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(5) .timeline-org': 'أكاديمية طويق',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(5) .timeline-text': '200 ساعة في الذكاء الاصطناعي والتعلم الآلي والتعلم العميق، مع تطبيق عملي مباشر.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(6) .timeline-date': 'مارس 2024 - يونيو 2024',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(6) .timeline-title': 'معسكر علوم البيانات والذكاء الاصطناعي T5',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(6) .timeline-org': 'سدايا',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(6) .timeline-text': '360 ساعة شملت SQL وPython وتحليل البيانات والتعلم الآلي والعميق (CNN وRNN) وMLOps.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(7) .timeline-date': 'أكتوبر 2023 - ديسمبر 2023',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(7) .timeline-title': 'معسكر علوم البيانات وتعلم الآلة',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(7) .timeline-org': 'أكاديمية طويق',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(7) .timeline-text': '200 ساعة، 5 مشاريع و50 تمريناً باستخدام Python وSQL وPandas وTableau وTensorFlow. تعلّمت تعلم الآلة (SVM وDecision Tree وRandom Forest) والتعلم العميق (CNNs).',
      ...
      '#skills .cert-item:nth-child(1) .cert-name': 'تطبيقات الذكاء الاصطناعي بالمحولات',
    ...
    html: {
      ...
      '.hero-subtitle': 'مهندس ذكاء اصطناعي <span class="accent">|</span> علوم بيانات',
      ...
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(5) .timeline-capstone': '<strong>مشروع التخرج — محلل التركيز للتعليم الإلكتروني:</strong> بنيت منصة تستخدم التعرف على الوجوه ونتائج الاختبارات لقياس تركيز الطلاب أثناء التعلم عن بُعد. <em>الأدوات: MediaPipe, OpenAI GPT-3.5, Whisper, Streamlit.</em>',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(6) .timeline-capstone': '<strong>مشروع التخرج — حاضر:</strong> نظام حضور ذكي يتعرّف على وجوه الطلاب ويسجّل حضورهم تلقائياً عند دخولهم الصف. <em>الأدوات: YOLO, Keras, Roboflow.</em>',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(7) .timeline-capstone': '<strong>مشروع التخرج — خراف:</strong> مشروع تصنيف صور بالـ CNN يحدد نوع التمر ومستوى النضج والأمراض. <em>الأدوات: Python, TensorFlow, Plotly Dash.</em>',
