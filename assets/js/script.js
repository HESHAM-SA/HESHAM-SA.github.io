...
const translations = {
  en: {
    ...
    description: 'Portfolio of Hesham Alsadan — Data Scientist, AI Engineer and Computer Science Teacher based in Riyadh, KSA.',
    langButton: 'العربية',
    ...
    text: {
      ...
      '.hero-text': 'Data Scientist, AI engineer, and Computer Science teacher in Riyadh — building machine learning and computer vision solutions.',
      ...
      '.about-text p:nth-of-type(1)': 'Results-driven Data Scientist and Computer Science teacher with expertise in AI, machine learning, and deep learning. Experienced in building end-to-end ML solutions and computer vision applications.',
      '.about-text p:nth-of-type(2)': 'I completed 4 in-person bootcamps and 3 programs — over 1,000 hours of training in Python, AI, data science, and full-stack web development — with 100% attendance. Currently teaching computer science fundamentals to 170 primary and intermediate students at the Ministry of Education, while continuing my journey in advanced AI, large language models (LLMs), and Generative AI.',
      ...
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(1) .timeline-title': 'Tuwaiq Tasaru Bootcamp Trainee',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(1) .timeline-org': 'Tuwaiq Academy',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(1) .timeline-text': 'Currently enrolled in the Tuwaiq Tasaru bootcamp, advancing skills in technology and innovation.',
      ...
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-text': 'Completed a 7-week intensive journey in software development using Python, building practical programming skills and real-world application experience.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-date': 'Feb 2026',
      ...
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-text': 'Completed advanced training in artificial intelligence, deepening expertise in modern AI techniques, models, and applications.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-date': 'Aug 2025 - Present',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-title': 'Computer Science Teacher',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-org': 'Ministry of Education',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-text': 'Teach primary and intermediate students (170 total) computer science fundamentals.',
      ...
      '#skills .cert-badge:nth-child(1) span': 'Alibaba Cloud Computing Engineer',
      '#skills .cert-badge:nth-child(2) span': 'IoT Certified',
      '#skills .cert-badge:nth-child(3) span': 'Drones Certified',
  ...
  ar: {
    ...
    description: 'معرض أعمال هشام السعدان — عالم بيانات ومهندس ذكاء اصطناعي ومعلم حاسب في الرياض، السعودية.',
    langButton: 'English',
    ...
    text: {
      ...
      '.hero-text': 'عالم بيانات ومهندس ذكاء اصطناعي ومعلم حاسب في الرياض — أبني حلول تعلم آلي ورؤية حاسوبية.',
      ...
      '.about-text p:nth-of-type(1)': 'عالم بيانات ومعلم حاسب آلي أمتلك خبرة في الذكاء الاصطناعي والتعلم الآلي والتعلم العميق. أعمل على بناء حلول تعلم آلي متكاملة وتطبيقات رؤية حاسوبية.',
      '.about-text p:nth-of-type(2)': 'أكملت 4 معسكرات حضورية و3 برامج — أكثر من 1,000 ساعة تدريبية في Python والذكاء الاصطناعي وعلوم البيانات وتطوير الويب الكامل — بنسبة حضور 100%. أدرّس حالياً أساسيات الحاسب لـ170 طالباً في المرحلتين الابتدائية والمتوسطة في وزارة التعليم، وأواصل التعمق في الذكاء الاصطناعي المتقدم والنماذج اللغوية الكبيرة والذكاء الاصطناعي التوليدي.',
      ...
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(1) .timeline-title': 'متدرب في معسكر طويق تسارع',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(1) .timeline-org': 'أكاديمية طويق',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(1) .timeline-text': 'ملتحق حالياً بمعسكر طويق تسارع لتطوير المهارات في التقنية والابتكار.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-date': '10 مايو 2026 - 25 يونيو 2026',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-title': 'متدرب في معسكر تطوير البرمجيات باستخدام Python',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-org': 'الأكاديمية السعودية الرقمية — SDA',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(2) .timeline-text': 'أكملت رحلة مكثفة لمدة 7 أسابيع في تطوير البرمجيات باستخدام Python، وبنيت مهارات برمجية عملية وخبرة تطبيقية.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-date': 'فبراير 2026',
      ...
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(3) .timeline-text': 'أكملت تدريباً متقدماً في الذكاء الاصطناعي، وعمّقت خبرتي في تقنيات ونماذج وتطبيقات الذكاء الاصطناعي الحديثة.',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-date': 'أغسطس 2025 - الآن',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-title': 'معلم حاسب آلي',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-org': 'وزارة التعليم',
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-text': 'أدرّس أساسيات الحاسب الآلي لطلاب المرحلتين الابتدائية والمتوسطة (170 طالباً).',
      ...
      '#skills .cert-badge:nth-child(1) span': 'مهندس حوسبة سحابية من Alibaba',
      '#skills .cert-badge:nth-child(2) span': 'معتمد في إنترنت الأشياء',
      '#skills .cert-badge:nth-child(3) span': 'معتمد في الطائرات بدون طيار',
