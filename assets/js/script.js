...
const translations = {
  ...
  ar: {
    ...
    text: {
      ...
      '#experience ol.timeline:first-of-type .timeline-item:nth-child(4) .timeline-text': 'أكملت 80 ساعة من التدريب المتقدم في الذكاء الاصطناعي، وعمّقت خبرتي في تقنيات ونماذج وتطبيقات الذكاء الاصطناعي الحديثة.',
